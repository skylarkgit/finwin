"""Google News RSS provider for finwin."""
...
class GoogleNewsProvider(BaseProvider):
    ...
    async def gather(
        ...
        **kwargs: Any,
        ...
        Returns:
            ProviderResult with news articles
        """
    ...
    def get_tool_description(self) -> str:
        ...
        return (
            "Search Google News for recent news articles about a company or topic. "
            "Returns article titles, sources, publication dates, and URLs."
        )
